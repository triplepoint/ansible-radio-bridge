# Intro
This role installs and configures a Docker-ized Python script which listens on a serial device for messages, and publishes them to an MQTT broker.
